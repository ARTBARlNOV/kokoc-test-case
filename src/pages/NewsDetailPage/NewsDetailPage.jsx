...
function NewsDetailPage() {
  ...
  const formattedDate = useMemo(() => (story ? new Date(story.time * 1000).toLocaleDateString() : ''), [story]);
  ...
  return (
    <div className="news-detail-container">
      ...
      <button type="button" onClick={handleRefresh} className="news-detail-refresh-button">Обновить</button>
